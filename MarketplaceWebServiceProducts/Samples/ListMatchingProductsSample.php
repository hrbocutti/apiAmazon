...
//$serviceUrl = "https://mws.amazonservices.com.cn/Products/2011-10-01";
 ...
 $service = new MarketplaceWebServiceProducts_Client(
        ...
        APPLICATION_VERSION,
        $config);
 define ( 'QUERY' , "DEWALT DG5142 Pro");
 $IDComerciante = MERCHANT_ID;
 $IDMarketplace = MARKETPLACE_ID;
 ...
 ***********************************************************************/
 ...
 $request->setSellerId($IDComerciante);
 $request->setMarketplaceId($IDMarketplace);
